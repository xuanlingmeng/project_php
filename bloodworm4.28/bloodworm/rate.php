...
<script type="text/javascript">
    var grid_data =
        [
            ...
            {taskid:"1",hjid:"3211820001",name:"联治滩",state:"查螺完成",person:"杨争辉", R:"2.36",color:"红色"},
            {taskid:"2",hjid:"3211820002",name:"华威滩",state:"灭螺完成",person:"崔洪博",R:"1.62",color:"橙色"},
            {taskid:"3",hjid:"3211820003",name:"新桥1号滩",state:"查螺完成",person:"陈超",R:"0.98",color:"黄色"},
            {taskid:"4",hjid:"3211820004",name:"新桥2号滩",state:"查螺完成",person:"曾睿",R:"1.91",color:"橙色"},
            {taskid:"5",hjid:"3211820005",name:"立新1号滩",state:"灭螺完成",person:"崔洪博",R:"0.53",color:"白色"},
            {taskid:"6",hjid:"3211820006",name:"立新2号滩",state:"灭螺完成", person:"杨争辉",R:"2.69",color:"红色"},
    ...
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "local",
            height: 450,
            colNames:[ '任务编号','环境编号','环境名称','负责人员','综合风险指数', '围栏显示颜色'],
            colModel:[
                ...
                {name:'taskid',index:'taskid', width:50, sorttype:"int", editable: true},
                {name:'hjid',index:'hjid', width:90, sorttype:"int", editable: true},
                {name:'name',index:'name', width:150,sorttype:"varchar",editable: true,editoptions:{size:"20",maxlength:"30"}},
                {name:'person',index:'person', width:90, sorttype:"varchar", editable: true},
                {name:'R',index:'R',width:90, sorttype:"int", editable: true},
                {name:'color',index:'color', width:90, editable: true,edittype:"select",editoptions:{value:"R:红色;O:橙色;Y:黄色;W:白色"}}
            ],
