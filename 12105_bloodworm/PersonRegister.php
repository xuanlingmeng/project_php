                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-8">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input class="col-xs-9 col-sm-6" type="text" id="form-field-username" placeholder="Username" value="Username" />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input class="col-sm-6" type="text" id="form-field-first" placeholder="Name" value="Name" />
                                                            <div class="help-block col-xs-12 col-sm-reset inline red">*必填！</div>
                                                        </div>
                                                    </div>
                                                </div>
