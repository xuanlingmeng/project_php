                        ...
                        <div id="signup-box" class="signup-box widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <form role="form" method="POST" action="register_test.php">
                                        <fieldset>
                                            ...
                                            <label class="block clearfix">
                                           	<span class="block input-icon input-icon-right">
                                                	<select type="text" class="form-control"  name="privilege" placeholder="申请权限"/>
                                                        <option value="1">申请权限</option>
                                                        <option value="2">查灭螺人员</option>
                                                        <option value="3">村级管理员</option>
                                                        <option value="4">镇级管理员</option>
                                                        <option value="5">区级管理员</option>
                                                        <option value="6">市级管理员</option>
                                                </select>
                                                <i class="ace-icon fa fa-envelope"></i>
                                             </span>
                                            </label>
