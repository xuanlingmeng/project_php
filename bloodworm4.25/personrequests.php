...
<script type="text/javascript">
    ...
    $.ajax(
        {
            ...
            success: function(data)
            {
                ...
                {
                  grid_data.push({username: data.username[i], email: data.email[i], privilege: data.privilege[i], decision:0});
               //  alert(data.username[i]);
               }
              //  alert("success");
            ...
            error: function()
            {
                alert("fail get the information");
            }
        }
    );
    ...
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "local",
            height: 450,
            colNames:[ '申请人用户名','邮箱','申请权限', '是否同意注册'],
            colModel:[
                ...
                {name:'username',index:'username', width:70, sorttype:"int", editable: true},
                {name:'email',index:'email', width:150, sorttype:"int", editable: true},
                {name:'privilege',index:'privilege', width:80,editable: true},
                {name:'decision',index:'decision', width:80, sorttype:"varchar", editable: true},
