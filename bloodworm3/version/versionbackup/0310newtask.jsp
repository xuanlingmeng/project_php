...
<head>
  ...
  <link rel="stylesheet" href="<%=basePath%>css/bootstrap-duallistbox.css" />
  <link rel="stylesheet" href="<%=basePath%>css/bootstrap-multiselect.css" />
  <link rel="stylesheet" href="<%=basePath%>css/select2.css" />
  <link rel="stylesheet" href="<%=basePath%>css/jquery-ui.custom.css" />
  ...
  <!-- ace styles -->
  <link rel="stylesheet" href="<%=basePath%>css/ace.css" class="ace-main-stylesheet" id="main-ace-style"/>

  <!--[if lte IE 9]>
  <link rel="stylesheet" href="<%=basePath%>css/ace-part2.css" class="ace-main-stylesheet"/>
  <![endif]-->

  <!--[if lte IE 9]>
  <link rel="stylesheet" href="<%=basePath%>css/ace-ie.css"/>
  <![endif]-->

  <!-- ace settings handler -->
  <script src="<%=basePath%>js/ace-extra.js"></script>
                  ...
                  <ul class="dropdown-menu-right dropdown-navbar dropdown-menu">
                    <li class="dropdown-content">
                      <ul class="dropdown-menu dropdown-navbar">
                        <li>
                          <a href="#">
                            <img src="<%=basePath%>avatars/avatar.png"
                                 class="msg-photo"
                                 alt="Alex's Avatar"/>
																<span class="msg-body">
                        ...
                        <li>
                          <a href="#">
                            <img src="<%=basePath%>avatars/avatar3.png"
                                 class="msg-photo"
                                 alt="Susan's Avatar"/>
																<span class="msg-body">
																	<span class="msg-title">
                        ...
                        <li>
                          <a href="#">
                            <img src="<%=basePath%>avatars/avatar4.png"
                                 class="msg-photo"
                                 alt="Bob's Avatar"/>
																<span class="msg-body">
																	<span class="msg-title">
                        ...
                        <li>
                          <a href="#">
                            <img src="<%=basePath%>avatars/avatar2.png"
                                 class="msg-photo"
                                 alt="Kate's Avatar"/>
																<span class="msg-body">
																	<span class="msg-title">
                        ...
                        <li>
                          <a href="#">
                            <img src="<%=basePath%>avatars/avatar5.png"
                                 class="msg-photo"
                                 alt="Fred's Avatar"/>
																<span class="msg-body">
																	<span class="msg-title">
  ...
  <div class="main-content">
    <div class="main-content-inner">
      ...
      <div class="row">
        <div class="col-xs-12">
          <!-- PAGE CONTENT BEGINS -->
          <form class="form-horizontal" role="form" name="new" method = "post" action="/home/newTask">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <label class="inline">
                  <input name="needSearch" type="radio" class="ace" checked="checked" value="0"/>
                  <span class="lbl middle"> 需要</span>
                </label>

                &nbsp; &nbsp; &nbsp;
                <label class="inline">
                  <input name="needSearch" type="radio" class="ace" value="1"/>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <textarea  id="form-field" name="form_field" cols="60" rows="5" data-toggle="modal" data-target="#WL"></textarea>
                <div class="help-block col-xs-12 col-sm-reset inline red">*</div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" id="form-field-9" name="form_field_9" data-toggle="modal" data-target="#myModal" />
                <div class="help-block col-xs-12 col-sm-reset inline red">*</div>
                <!-- page trigger modal -->
                ...
                <script src="<%=basePath%>js/fuelux/fuelux.tree.js"></script>
                <script type="text/javascript">
                  jQuery(function($){
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input class="col-sm-3 date-picker" id="id-date-picker-1" name="id_date" type="date" data-date-format="dd-mm-yyyy" />
                <div class="help-block col-xs-12 col-sm-reset inline red">*</div>
              </div>
            </div>
            ...
            <div class="">
              <div class="col-md-offset-3 col-md-9">
                <button class="btn btn-info" id="ok">
...
<!--[if IE]>
<script type="text/javascript">
  window.jQuery || document.write("<script src='<%=basePath%>js/jquery1x.js'>" + "<" + "/script>");
</script>
<![endif]-->
<script type="text/javascript">
  if ('ontouchstart' in document.documentElement) document.write("<script src='<%=basePath%>js/jquery.mobile.custom.js'>" + "<" + "/script>");
</script>

<!-- page specific plugin scripts -->
<script src="<%=basePath%>js/jquery.bootstrap-duallistbox.js"></script>
<script src="<%=basePath%>js/jquery.raty.js"></script>
...
<script src="<%=basePath%>js/ace/elements.scroller.js"></script>
<script src="<%=basePath%>js/ace/elements.colorpicker.js"></script>
<script src="<%=basePath%>js/ace/elements.fileinput.js"></script>
<script src="<%=basePath%>js/ace/elements.typeahead.js"></script>
<script src="<%=basePath%>js/ace/elements.wysiwyg.js"></script>
<script src="<%=basePath%>js/ace/elements.spinner.js"></script>
<script src="<%=basePath%>js/ace/elements.treeview.js"></script>
<script src="<%=basePath%>js/ace/elements.wizard.js"></script>
<script src="<%=basePath%>js/ace/elements.aside.js"></script>
<script src="<%=basePath%>js/ace/ace.js"></script>
<script src="<%=basePath%>js/ace/ace.ajax-content.js"></script>
<script src="<%=basePath%>js/ace/ace.touch-drag.js"></script>
<script src="<%=basePath%>js/ace/ace.sidebar.js"></script>
<script src="<%=basePath%>js/ace/ace.sidebar-scroll-1.js"></script>
<script src="<%=basePath%>js/ace/ace.submenu-hover.js"></script>
<script src="<%=basePath%>js/ace/ace.widget-box.js"></script>
<script src="<%=basePath%>js/ace/ace.settings.js"></script>
<script src="<%=basePath%>js/ace/ace.settings-rtl.js"></script>
<script src="<%=basePath%>js/ace/ace.settings-skin.js"></script>
<script src="<%=basePath%>js/ace/ace.widget-on-reload.js"></script>
<script src="<%=basePath%>js/ace/ace.searchbox-autocomplete.js"></script>
