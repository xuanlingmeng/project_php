    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" role="form" name="eliminate">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label id="taskid" class="control-label no-padding-right">3211820001</label>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="location"> 工程地点 </label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label id="form-field-2" class="control-label no-padding-right">录安洲原3队堤外江滩</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label id="snailarea" class="control-label no-padding-right">32平方米</label>
                            </div>
                        </div>
                        ...
                        <div class="">
                            <div class="col-md-offset-4 col-md-12">
                                <button class="btn btn-info" id="ok" type="button">
