                                                ...
                                                <div class="col-xs-12">
                                                    ...
                                                    <form class="form-horizontal" role="form">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label no-padding-right" for="form-bs-8"> 环境编号 </label>

                                                            <div class="col-sm-5">
                                                                <input type="text" id="form-bs-8" class="col-sm-5" />
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label no-padding-right" for="form-bs-9"> 环境名称 </label>

                                                            <div class="col-sm-5">
                                                                <input type="text" id="form-bs-9" class="col-sm-5" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <select name="beachtype" class="col-sm-4">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label no-padding-right" for="form-bs-1"> 所属县、乡（镇、街道）、村 </label>

                                                            <div class="col-sm-7">
                                                                <input type="text" id="form-bs-1"  class="col-sm-10" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-2">
                                                                <input type="text" id="form-bs-2" class="col-sm-5"/>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="text" id="form-bs-4" class="col-sm-5" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="text" id="form-bs-5" class="col-sm-5" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="text" id="form-bs-6" class="col-sm-5" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="text" id="form-bs-7" class="col-sm-5" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-2">
                                                                <input type="text" id="form-ba-1" class="col-sm-5" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-2">
                                                                <input type="text" id="form-ba-2" class="col-sm-7"/>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-2">
                                                                <input type="text" id="form-ba-3" class="col-sm-7"/>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="text" id="form-ba-4" class="col-sm-5"/>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-2">
                                                                <input type="text" id="form-ba-5" class="col-sm-7"/>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-2">
                                                                <input type="text" id="form-ba-6"  class="col-sm-7" />
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-xs-12">
                                                    ...
                                                    <form class="form-horizontal" role="form">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="text" id="form-ch-2"  class="col-sm-5" />
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label no-padding-right" for="form-ch-3"> 深度(m) </label>

                                                            <div class="col-sm-5">
                                                                <input type="text" id="form-ch-3" class="col-sm-5" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="text" id="form-ch-5" class="col-sm-5" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label no-padding-right" for="form-ch-11"> 面积 </label>

                                                            <div class="col-sm-5">
                                                                <input type="text" id="form-ch-11"  class="col-sm-5" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="text" id="form-ch-8"  class="col-sm-5" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="text" id="form-ch-10"  class="col-sm-5" />
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-xs-12">
                                                    ...
                                                    <form class="form-horizontal" role="form">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="text" id="form-ch-7" class="col-sm-4" />
                                                            </div>
                                                        </div>
