    ...
    $.ajax(
        {
            ...
            success: function(data)
            {
                ...
                {
//                    if(data.data.Color_WL[i]==0)
//                    {data.data.Color_WL[i]="红色";}
//                    else if(data.data.Color_WL[i]==1)
//                    {data.data.Color_WL[i]="橙色";}
//                    else if(data.data.Color_WL[i]==2)
//                    {data.data.Color_WL[i]="黄色";}
//                    else if(data.data.Color_WL[i]==3)
//                    {data.data.Color_WL[i]="白色";}


                    grid_data.push({taskid: data.Task_Id[i], name: data.EnvirName[i],  hjid:data.Environment_Id[i], person:data.person[i],color: data.Color_WL[i], R:data.RiskIndex[i]});
