...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-04-29 12:10:10
...
(7, '1001', b'0', 1, 1234.8900, 12.0000, b'1', NULL, '2016-04-10', 125.0000, 7.0000, 12.0000, 7.0000, 1.0000, NULL, NULL),
(8, '1007', b'0', 1, 78998.4500, 1.0000, b'1', NULL, '2016-04-06', 125.0000, 100.0000, 125.0000, 10.0000, 2.0000, NULL, NULL);
...
(6, '340048', '1007', b'0', 139181.9687, NULL, NULL, NULL, NULL, b'0', 'Cats', 'Cats', 1, b'1', '2016-04-12');
...
(7, 0, 0, 1.250, 0.000, 0.000, NULL, 125.000, NULL),
(8, 0, 0, 0.020, 0.000, 0.000, NULL, 2.000, NULL);
...
(8, 0.143, 0.000, 0.000, 12.000, 0.000, 0.000, 0.000, '1001'),
(9, 0.020, 0.000, 0.000, 1.000, 0.000, 0.000, 0.000, '1007');
...
(8, '1001', 0, '340041', 8, 10, 7, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9, '1007', 0, '340048', 9, 11, 8, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(6, '1007', '120.002452, 31.803938 |120.001374, 31.805595 |', 210.5361, 0, NULL, NULL, NULL, b'1');
...
--
ALTER TABLE `tb_e_account`
  MODIFY `Account_Id` int(4) NOT NULL AUTO_INCREMENT COMMENT '账号ID', AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `tb_e_examinesnail`
  MODIFY `ExaTask_Id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `tb_his_beachchanges`
  MODIFY `_Id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `tb_is_infectionreason`
  MODIFY `_Id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- 使用表AUTO_INCREMENT `tb_is_reason`
--
ALTER TABLE `tb_is_reason`
  MODIFY `_Id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `tb_is_sum`
  MODIFY `Is_Id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
