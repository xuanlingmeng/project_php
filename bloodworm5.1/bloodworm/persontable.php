    ...
    $.ajax(
        {
            ...
            success: function(data)
            {
                for(var i = 0; i < data.long; i++)
                {
                  ...
                  //  data.Person_Privilege[i]="权限等级".data.Person_Privilege[i];
                    grid_data.push({accountid: i+1, name: data.Person_Name[i], sex:data.Person_Sex[i],dep: data.Person_field[i],tel:data.Person_Mobilephone[i], pri:data.Person_Privilege[i]});
...
//        [
//
//            {accountid:"1",name:"曾睿",sex:"女",dep:"研发部",tel:"15150555153", pri:"等级三"},
//            {accountid:"2",name:"陈超",sex:"男",dep:"研发部",tel:"15150555154", pri:"等级三"},
//            {accountid:"3",name:"杨争辉",sex:"男",dep:"测试部",tel:"15150555155", pri:"等级三"},
//            {accountid:"4",name:"崔洪博",sex:"男",dep:"研发部",tel:"15150555156", pri:"等级三"},
//            {accountid:"5",name:"匡琳琳",sex:"女",dep:"研发部",tel:"15150555157", pri:"等级三"},
//            {accountid:"6",name:"刘浩波",sex:"男",dep:"现场部",tel:"15150555158", pri:"等级三"},
//            {accountid:"7",name:"王仁",sex:"男",dep:"人事部",tel:"15150555159", pri:"等级三"},
//
//        ];
    ...
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "local",
            height: 450,
            colNames:[ '账号编号','账号名','用户性别','所属区域', '手机号码','权限等级'],
            colModel:[
                ...
                {name:'accountid',index:'accountid', width:50, sorttype:"int", editable: true},
                {name:'name',index:'name', width:150, sorttype:"varchar",editable: true,editoptions:{size:"20",maxlength:"30"}},
                {name:'sex',index:'sex', width:80, editable: true,edittype:"select",editoptions:{value:"M:男;W:女"}},
                {name:'dep',index:'dep',width:90, editable: true,editoptions:{size:"20",maxlength:"30"}},
                {name:'tel',index:'tel', width:90, sorttype:"int", editable: true},
                {name:'pri',index:'pri', width:100, editable: true,edittype:"select",editoptions:{value:"O:等级一;TW:等级二;TH:等级三"}}
            ],
