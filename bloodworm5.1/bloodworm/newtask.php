            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" name="new" action="newtaskdeal.php" method="POST" >
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" > 人员选择 </label>

                            <div class="col-sm-9">
                                <select name="form-field-9" >
                                    <?php
                                    class person
                                    {
                                        Public $privilege;
                                    ...
                                    $result = mysqli_query($con,"SELECT * FROM tb_e_account WHERE Account_Privilege=1");
                                    ...
                                    for ($i = 0; $i < $person->length - 1; $i++) {
                                        ...
                                        <option value="<?php echo  $person->username[$i]; ?>"><?php echo $person->username[$i]; ?></option>
                                        <?php
                                    }
                                    ?>
                                    <option
                                        value="<?php echo  $person->username[$person->length - 1]; ?>"><?php echo $person->username[$person->length - 1]; ?></option></select>
                                <?php
                                }
                                ?>
                                <?php
                                if($person->length==1) {
                                   ?>
                                     <option value="none">/</option>
                                    <option value="<?php echo $person->username[0]; ?>"><?php echo $person->username[0]; ?></option></select>
                               <?php
                                }
                                ?>
                                ...
                                if($person->length==0) {
                                 ?>
                                   <option value="none">/</option>
                                 <option value="<?php echo "none"; ?>"><?php echo"暂无查灭螺人员"; ?></option></select>
                                <?php
                                }
                                ?>
                            </div>
