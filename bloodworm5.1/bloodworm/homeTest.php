                                                ...
                                                success:function(data)
                                                {
                                                   ...
                                                   // alert(data);
                                                    ...
                                                    for(var i=0;i<data[i][6];i++)
                                                    {
                                                        ...
                                                        if(data[i][7]==0) {data[i][7]="blue";}
                                                        else if(data[i][7]==1) {data[i][7]="red";}
                                                        else if(data[i][7]==2) {data[i][7]="orange";}
                                                        else if(data[i][7]==3) {data[i][7]="yellow";}
                                                        else if(data[i][7]==4) {data[i][7]="white";}
                                                        // alert(longitude[0]);
                                                       // alert(data[i][6]);
                                                        // alert(latitude[0]) ;
                                                        //  alert(radius);
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            var circle = new BMap.Circle(new BMap.Point(longitude[0],latitude[0]),radius,{strokeColor:data[i][7], strokeWeight:6, strokeOpacity:0.5,fillOpacity: 0.0}); //创建圆
                                                            map.addOverlay(circle);            //增加圆
                                                            circle.addEventListener("click",overlay_style);
                                                        }
